            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">
                            <a href="<?= base_url();?>pegawai/formulir/1" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah Pegawai</a>
                            <a href="<?= base_url();?>pegawai/struktur" class="btn bg-olive btn-sm"><i class="fa fa-cubes"></i> Struktur</a>
                            <a href="<?= base_url();?>pegawai/jabatan" class="btn btn-info btn-sm"><i class="fa fa-gear"></i> Jabatan</a>
                        </h3>
                        ...
                        <div style="float:right">
                            <form class="form-inline" method="post" action="<?= base_url(); ?>pegawai" method="post" style="float:right;" onsubmit="showloading()">
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="<?= base_url(); ?>pegawai" class="btn bg-purple btn-sm" onclick="showloading()">Refresh</a>
                                </div>
                                <div class="form-group">
